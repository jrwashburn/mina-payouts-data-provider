...
router.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var messages, blockSummary, currentEpoch, response, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                blockSummary = _a.sent();
                currentEpoch = getCurrentEpoch(blockSummary.globalslotsincegenesis);
                response = {
...
function getCurrentEpoch(slotNumber) {
    return Math.floor(slotNumber / environmentConfiguration_1.default.slotsPerEpoch);
}
